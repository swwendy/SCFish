...
namespace SWS
{
    ...
    public class splineMoveEditor : moveEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Object.FindProperty("forwardDir"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("offset"));

            EditorGUILayout.PropertyField(m_Object.FindProperty("startPoint"));
            EditorGUILayout.PropertyField(m_Object.FindProperty("delay"));
